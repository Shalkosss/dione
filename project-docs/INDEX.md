...
Inventario de los 19 archivos del Project knowledge de DIONE v3.
...
| 6 | [HUNTER_MODES.md](HUNTER_MODES.md) | 3 modos del Hunter (Fundamental, Técnico-Wyckoff, Combinado) + Divergence. Disclaimer Phase B |
| 7 | [SMART_MONEY.md](SMART_MONEY.md) | 4 fuentes (13F, Form 4, dark pool, SI). Score 0-100. Overview pendiente Fase 3 |
...
| 11 | [COMMANDS_status.md](COMMANDS_status.md) | Estado real de cada comando: AUTO / PASTE / WEB-APP / NO EXISTE |
...
| 15 | [DATA_SOURCE.md](DATA_SOURCE.md) | Endpoints reales, convenciones de data, gate y pre-score, limitaciones del snapshot |
| 16 | [README_HIDDEN_GEMS.md](README_HIDDEN_GEMS.md) | Arquitectura real del screener: cron + EDGAR + Stooq + Supabase |
| 17 | [READING_CANON.md](READING_CANON.md) | Base de conocimiento asumida (Tier 1-4) que DIONE puede citar |
| 18 | [SETUP_GUIDE.md](SETUP_GUIDE.md) | Configuración del Project + pendientes operativos (no despliegue) |
| 19 | [KEYS.md](KEYS.md) | Claves y secretos. Finnhub termina en `q420` (no `nag`) |
